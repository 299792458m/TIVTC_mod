  ...
  int *blockN, int &xblocksi, int *mics, bool ddebug, int bits_per_pixel)
{
  ...
  mymemset(cArray.get(), 0, arraysize * sizeof(int));
  ...
  int Width, int tpitch, int bits_per_pixel)
{
  ...
  case 8: AnalyzeDiffMask_Planar<uint8_t, 8>(dstp, dst_pitch, tbuffer.get(), tpitch, Width, Height, cpuFlags); break;
  case 10: AnalyzeDiffMask_Planar<uint16_t, 10>(dstp, dst_pitch, tbuffer.get(), tpitch, Width, Height, cpuFlags); break;
  case 12: AnalyzeDiffMask_Planar<uint16_t, 12>(dstp, dst_pitch, tbuffer.get(), tpitch, Width, Height, cpuFlags); break;
  case 14: AnalyzeDiffMask_Planar<uint16_t, 14>(dstp, dst_pitch, tbuffer.get(), tpitch, Width, Height, cpuFlags); break;
  case 16: AnalyzeDiffMask_Planar<uint16_t, 16>(dstp, dst_pitch, tbuffer.get(), tpitch, Width, Height, cpuFlags); break;
  }
}
